...
/*   Updated: 2026/05/21 16:54:40 by bbeaurai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_dongle
{
    ...
    pthread_cond_t  cond;       // Pour endormir les codeurs qui attendent ce dongle
...
typedef struct s_coder
{
    ...
    struct s_data   *data;         // Pointeur vers la structure globale pour accéder aux paramètres
}   t_coder;
...
typedef struct s_data
{
    ...
    pthread_mutex_t print_lock;     // OBLIGATOIRE : pour éviter que les printf se mélangent
    pthread_mutex_t state_lock;     // Pour protéger l'accès à 'sim_running' et aux variables du moniteur
